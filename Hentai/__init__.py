...
BOT_TOKEN = environ.get('BOT_TOKEN', '6581906985:AAFixzeerJj_2p_EgKI4XP-1lvhRiBlR_NI')
#BOT_TOKEN = environ.get('BOT_TOKEN', '6108571944:AAEkzPB3zJUFLfFddBHY0DVnTeqQLrgHa6A')
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://realaizenbots:arindam964188@cluster0.nevbx2y.mongodb.net/?retryWrites=true&w=majority')
OWNER_ID = 720518864
DEV_USERS = "" #[1695508822, 5110399944]
LOG_CHANNEL = -1001300754259
BOT_USERNAME = "ahlinks_bot"
