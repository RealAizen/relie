...
BOT_TOKEN = environ.get('BOT_TOKEN', '6016198379:AAGDwMmSAiZ1MK6nMx-fWVaUFlG9s9msbUE')
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://cloud:cloud69@cluster0.bieyjxe.mongodb.net/?retryWrites=true&w=majority')
OWNER_ID = int(environ.get('OWNER_ID', 669641125))
DEV_USERS = [1695508822, 5110399944, 720518864]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001300754259))
